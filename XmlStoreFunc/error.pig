...
-- store as XML
STORE x_products INTO '/user/plasne/output-201705120930/product-xml' USING output.XML('/user/plasne/error.json');
STORE x_customers INTO '/user/plasne/output-201705120930/customer-xml' USING output.XML('/user/plasne/error.json');
