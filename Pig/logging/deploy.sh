...
curl -o /usr/local/customize/azure-log4j.jar "https://raw.githubusercontent.com/plasne/ADFHDIPIG-pipeline/master/Pig/lib/azure-log4j.jar"
curl -o /usr/local/customize/azure-api-0.4.4.jar "https://raw.githubusercontent.com/plasne/ADFHDIPIG-pipeline/master/Pig/lib/azure-api-0.4.4.jar"
